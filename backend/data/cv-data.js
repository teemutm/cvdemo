  ...
  experience: [
    {
      ...
      title: "Senior Cloud Architect",
      company: "Cloud2 Oy",
      website: "www.cloud2.net",
      description: "I work with customers in healthcare, gaming, energy and media sectors. As part of development teams I understand the challenges they have with automation, containers, tests and deployments. I design and implement AWS and GCP organization structures and cloud architecture in cooperation with the developers to suit best with the software design. I love to use containers and Kubernetes with platforms like AWS EKS / ECS or GCP Cloud Run. Everything is done with IAC tools like Terraform and automated with Github Actions or Code Pipeline etc.",
      highlights: [
        "Designed AWS and GCP landing zones with Terraform",
    ...
    {
      id: 2,
      period: "6/2018 - 6/2019",
      title: "DevOps Engineer",
      company: "Polar Squad Oy",
    ...
    },
    {
      ...
      keywords: ["Linux", "Puppet", "CentOS", "Xenserver", "Tomcat", "Java", "Apache", "Nginx", "Mysql", "Galera", "PostgreSQL", "Zabbix"],
      highlights: [],
      current: false
    },
    {
      ...
      keywords: ["OpenVZ", "Vmware ESX", "MySQL-replication", "Apache", "mod-perl"],
      highlights: [],
      current: false
    }
  ],
  ...
  education: [
    {
      id: 1,
      period: "2004 - 2006",
      degree: "Tietotekniikan ammattitutkinto",
      institution: "TAKK, Tampere",
      description: "System administrator training program."
    }
  ],
